// For simplicity during the prototype, this is a copy of
// https://github.com/tidwall/resp/blob/master/resp.go with the .Buffered and
// .Peek methods patched in. For a final version these should go upstream.
